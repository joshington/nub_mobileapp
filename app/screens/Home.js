                ...
                */}
                ...
                <CardContainer>
                    ...
                    <Card 
                        ...
                        colorChange={false}
                        customIcon={
                            <FontAwesome5 name="donate" size={72} color="#FFFFFF" />
                        }
                        alternate={true}
                        altercolm={true}
                    />
                    <Card 
                        ...
                        colorChange={true}
                        customIcon={
                            <MaterialCommunityIcons name="account-circle" size={72} color="#FFFFFF" />
                        }
                        alternate={true}
                    />
                    <Card 
                    ...
                    <Card 
                        ...
                        colorChange={true}
                        customIcon={
                            <MaterialCommunityIcons name="cursor-pointer" size={72} color="#FFFFFF" />
                        }
                    />
                {/*
                    <ListCard 
